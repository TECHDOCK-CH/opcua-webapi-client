...
/**
 * EventFieldList Class Doc Comment
 *
 * @category Class
 * @description [Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part4/7.25.3).
 * @package  TechDock\OpcUaWebApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EventFieldList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventFieldList';
    ...
    protected static $openAPITypes = [
        'client_handle' => 'int',
        'event_fields' => '\TechDock\OpcUaWebApiClient\Model\Variant[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('event_fields', $data ?? [], null);
    }
    ...
    */
    ...
    public function setClientHandle($client_handle)
    {
        ...
        if (($client_handle > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $client_handle when calling EventFieldList., must be smaller than or equal to 4294967295.');
        }
        if (($client_handle < 0)) {
            throw new \InvalidArgumentException('invalid value for $client_handle when calling EventFieldList., must be bigger than or equal to 0.');
        }
     ...
     * Sets event_fields
     *
     * @param \TechDock\OpcUaWebApiClient\Model\Variant[]|null $event_fields event_fields
     *
     * @return self
     */
    public function setEventFields($event_fields)
    {
        if (is_null($event_fields)) {
            throw new \InvalidArgumentException('non-nullable event_fields cannot be null');
        }
