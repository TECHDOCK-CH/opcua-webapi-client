 ...
 *
 * @category Class
 * @description [Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part4/5.7.5/#5.7.5.2).
 * @package  TechDock\OpcUaWebApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CancelResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cancel_count', $data ?? [], 0);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cancel_count']) && ($this->container['cancel_count'] > 4294967295)) {
            $invalidProperties[] = "invalid value for 'cancel_count', must be smaller than or equal to 4294967295.";
        }

        if (!is_null($this->container['cancel_count']) && ($this->container['cancel_count'] < 0)) {
            $invalidProperties[] = "invalid value for 'cancel_count', must be bigger than or equal to 0.";
        }
     ...
     * Sets cancel_count
     *
     * @param int|null $cancel_count cancel_count
     *
     * @return self
     */
    public function setCancelCount($cancel_count)
    {
        ...
        if (($cancel_count > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $cancel_count when calling CancelResponse., must be smaller than or equal to 4294967295.');
        }
        if (($cancel_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $cancel_count when calling CancelResponse., must be bigger than or equal to 0.');
        }
