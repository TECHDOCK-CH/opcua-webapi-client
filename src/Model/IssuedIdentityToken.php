...
/**
 * IssuedIdentityToken Class Doc Comment
 *
 * @category Class
 * @description [Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part5/12.3.15/#12.3.15.2).
 * @package  TechDock\OpcUaWebApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class IssuedIdentityToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IssuedIdentityToken';
    ...
    */
     ...
     * Sets token_data
     *
     * @param string|null $token_data token_data
     *
     * @return self
     */
     ...
     *
     * @param string|null $encryption_algorithm encryption_algorithm
     *
     * @return self
     */
