...
/**
 * SimpleTypeDescription Class Doc Comment
 *
 * @category Class
 * @description [Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part5/12.35).
 * @package  TechDock\OpcUaWebApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SimpleTypeDescription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SimpleTypeDescription';
    ...
    */
    ...
    public function setBuiltInType($built_in_type)
    {
        ...
        if (($built_in_type > 255)) {
            throw new \InvalidArgumentException('invalid value for $built_in_type when calling SimpleTypeDescription., must be smaller than or equal to 255.');
        }
        if (($built_in_type < 0)) {
            throw new \InvalidArgumentException('invalid value for $built_in_type when calling SimpleTypeDescription., must be bigger than or equal to 0.');
        }
