...
/**
 * FindServersRequest Class Doc Comment
 *
 * @category Class
 * @description [Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part4/5.5.2/#5.5.2.2).
 * @package  TechDock\OpcUaWebApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FindServersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FindServersRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('server_uris', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string[]|null
     */
    public function getServerUris()
    {
        return $this->container['server_uris'];
    }

    /**
     * Sets server_uris
     *
     * @param string[]|null $server_uris server_uris
     *
     * @return self
     */
    public function setServerUris($server_uris)
    {
        if (is_null($server_uris)) {
            throw new \InvalidArgumentException('non-nullable server_uris cannot be null');
        }
        $this->container['server_uris'] = $server_uris;
