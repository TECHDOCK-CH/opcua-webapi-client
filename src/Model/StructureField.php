...
/**
 * StructureField Class Doc Comment
 *
 * @category Class
 * @description [Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part5/12.2.12/#12.2.12.10).
 * @package  TechDock\OpcUaWebApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class StructureField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StructureField';
    ...
    */
    ...
    public function setMaxStringLength($max_string_length)
    {
        ...
        if (($max_string_length > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $max_string_length when calling StructureField., must be smaller than or equal to 4294967295.');
        }
        if (($max_string_length < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_string_length when calling StructureField., must be bigger than or equal to 0.');
        }
