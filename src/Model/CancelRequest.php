    ...
    */
    ...
    public function setRequestHandle($request_handle)
    {
        ...
        if (($request_handle > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $request_handle when calling CancelRequest., must be smaller than or equal to 4294967295.');
        }
        if (($request_handle < 0)) {
            throw new \InvalidArgumentException('invalid value for $request_handle when calling CancelRequest., must be bigger than or equal to 0.');
        }
