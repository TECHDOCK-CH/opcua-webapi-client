...
/**
 * RelativePathElement Class Doc Comment
 *
 * @category Class
 * @description [Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part4/7.31).
 * @package  TechDock\OpcUaWebApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RelativePathElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RelativePathElement';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_inverse', $data ?? [], false);
    ...
    */
     ...
     * Sets is_inverse
     *
     * @param bool|null $is_inverse is_inverse
     *
     * @return self
     */
    public function setIsInverse($is_inverse)
    {
        if (is_null($is_inverse)) {
            throw new \InvalidArgumentException('non-nullable is_inverse cannot be null');
        }
