...
/**
 * JsonActionMetaDataMessage Class Doc Comment
 *
 * @category Class
 ...
 */
class JsonActionMetaDataMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JsonActionMetaDataMessage';
    ...
    protected static $openAPITypes = [
        ...
        'timestamp' => '\DateTime',
        'action_targets' => '\TechDock\OpcUaWebApiClient\Model\ActionTargetDataType[]',
        'request' => '\TechDock\OpcUaWebApiClient\Model\DataSetMetaDataType',
        'response' => '\TechDock\OpcUaWebApiClient\Model\DataSetMetaDataType',
        'action_methods' => '\TechDock\OpcUaWebApiClient\Model\ActionMethodDataType[]'
    ];
    ...
    protected static $setters = [
        ...
        'action_targets' => 'setActionTargets',
        'request' => 'setRequest',
        'response' => 'setResponse',
        'action_methods' => 'setActionMethods'
    ];
    ...
    protected static $getters = [
        ...
        'action_targets' => 'getActionTargets',
        'request' => 'getRequest',
        'response' => 'getResponse',
        'action_methods' => 'getActionMethods'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('action_targets', $data ?? [], null);
        $this->setIfExists('request', $data ?? [], null);
        $this->setIfExists('response', $data ?? [], null);
        $this->setIfExists('action_methods', $data ?? [], null);
    }
    ...
    */
    ...
    public function setDataSetWriterId($data_set_writer_id)
    {
        ...
        if (($data_set_writer_id > 65535)) {
            throw new \InvalidArgumentException('invalid value for $data_set_writer_id when calling JsonActionMetaDataMessage., must be smaller than or equal to 65535.');
        }
        if (($data_set_writer_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $data_set_writer_id when calling JsonActionMetaDataMessage., must be bigger than or equal to 0.');
        }
     ...
     * Gets action_targets
     *
     * @return \TechDock\OpcUaWebApiClient\Model\ActionTargetDataType[]|null
     */
    public function getActionTargets()
    {
        return $this->container['action_targets'];
    }

    /**
     * Sets action_targets
     *
     * @param \TechDock\OpcUaWebApiClient\Model\ActionTargetDataType[]|null $action_targets action_targets
     *
     * @return self
     */
    public function setActionTargets($action_targets)
    {
        if (is_null($action_targets)) {
            throw new \InvalidArgumentException('non-nullable action_targets cannot be null');
        }
        $this->container['action_targets'] = $action_targets;
     ...
     * Sets request
     *
     * @param \TechDock\OpcUaWebApiClient\Model\DataSetMetaDataType|null $request request
     *
     * @return self
     */
     ...
     * Sets response
     *
     * @param \TechDock\OpcUaWebApiClient\Model\DataSetMetaDataType|null $response response
     *
     * @return self
     */
     ...
     * Gets action_methods
     *
     * @return \TechDock\OpcUaWebApiClient\Model\ActionMethodDataType[]|null
     */
    public function getActionMethods()
    {
        return $this->container['action_methods'];
    }

    /**
     * Sets action_methods
     *
     * @param \TechDock\OpcUaWebApiClient\Model\ActionMethodDataType[]|null $action_methods action_methods
     *
     * @return self
     */
    public function setActionMethods($action_methods)
    {
        if (is_null($action_methods)) {
            throw new \InvalidArgumentException('non-nullable action_methods cannot be null');
        }
        $this->container['action_methods'] = $action_methods;
