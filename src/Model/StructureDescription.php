...
/**
 * StructureDescription Class Doc Comment
 *
 * @category Class
 * @description [Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part5/12.33).
 * @package  TechDock\OpcUaWebApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class StructureDescription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StructureDescription';
    ...
    protected static $openAPITypes = [
        'structure_definition' => '\TechDock\OpcUaWebApiClient\Model\StructureDefinition',
        'data_type_id' => 'string',
        'name' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \TechDock\OpcUaWebApiClient\Model\StructureDefinition|null
     */
     ...
     *
     * @param \TechDock\OpcUaWebApiClient\Model\StructureDefinition|null $structure_definition structure_definition
     *
     * @return self
     */
    public function setStructureDefinition($structure_definition)
    {
        if (is_null($structure_definition)) {
            throw new \InvalidArgumentException('non-nullable structure_definition cannot be null');
        }
