...
/**
 * MonitoredItemNotification Class Doc Comment
 *
 * @category Class
 ...
 */
class MonitoredItemNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MonitoredItemNotification';
    ...
    */
    ...
    public function setClientHandle($client_handle)
    {
        ...
        if (($client_handle > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $client_handle when calling MonitoredItemNotification., must be smaller than or equal to 4294967295.');
        }
        if (($client_handle < 0)) {
            throw new \InvalidArgumentException('invalid value for $client_handle when calling MonitoredItemNotification., must be bigger than or equal to 0.');
        }
