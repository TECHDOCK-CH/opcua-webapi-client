 ...
 *
 * @category Class
 * @description [Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part4/7.26).
 * @package  TechDock\OpcUaWebApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NotificationMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NotificationMessage';
    ...
    protected static $openAPITypes = [
        ...
        'notification_data' => '\TechDock\OpcUaWebApiClient\Model\ExtensionObject[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('notification_data', $data ?? [], null);
    }
    ...
    */
    ...
    public function setSequenceNumber($sequence_number)
    {
        ...
        if (($sequence_number > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $sequence_number when calling NotificationMessage., must be smaller than or equal to 4294967295.');
        }
        if (($sequence_number < 0)) {
            throw new \InvalidArgumentException('invalid value for $sequence_number when calling NotificationMessage., must be bigger than or equal to 0.');
        }
     ...
     * Sets publish_time
     *
     * @param \DateTime|null $publish_time publish_time
     *
     * @return self
     */
     ...
     *
     * @param \TechDock\OpcUaWebApiClient\Model\ExtensionObject[]|null $notification_data notification_data
     *
     * @return self
     */
    public function setNotificationData($notification_data)
    {
        if (is_null($notification_data)) {
            throw new \InvalidArgumentException('non-nullable notification_data cannot be null');
        }
