...
/**
 * PubSubGroupDataType Class Doc Comment
 *
 * @category Class
 * @description [Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part14/6.2.5/#6.2.5.7).
 * @package  TechDock\OpcUaWebApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PubSubGroupDataType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PubSubGroupDataType';
    ...
    */
    ...
    public function setMaxNetworkMessageSize($max_network_message_size)
    {
        ...
        if (($max_network_message_size > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $max_network_message_size when calling PubSubGroupDataType., must be smaller than or equal to 4294967295.');
        }
        if (($max_network_message_size < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_network_message_size when calling PubSubGroupDataType., must be bigger than or equal to 0.');
        }
