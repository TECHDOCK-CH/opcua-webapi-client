...
/**
 * EnumDescription Class Doc Comment
 *
 * @category Class
 * @description [Link to specification](https://reference.opcfoundation.org/v105/Core/docs/Part5/12.34).
 * @package  TechDock\OpcUaWebApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EnumDescription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnumDescription';
    ...
    protected static $openAPITypes = [
        'enum_definition' => '\TechDock\OpcUaWebApiClient\Model\EnumDefinition',
        'built_in_type' => 'int',
        'data_type_id' => 'string',
        'name' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'built_in_type' => 'int32',
        'data_type_id' => 'UaNodeId',
        'name' => 'UaQualifiedName'
    ];
    ...
    protected static $setters = [
        'enum_definition' => 'setEnumDefinition',
    ...
    protected static $getters = [
        'enum_definition' => 'getEnumDefinition',
    ...
    {
        $this->setIfExists('enum_definition', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets enum_definition
     *
     * @return \TechDock\OpcUaWebApiClient\Model\EnumDefinition|null
     */
    public function getEnumDefinition()
    {
        return $this->container['enum_definition'];
    }

    /**
     * Sets enum_definition
     *
     * @param \TechDock\OpcUaWebApiClient\Model\EnumDefinition|null $enum_definition enum_definition
     *
     * @return self
     */
    public function setEnumDefinition($enum_definition)
    {
        if (is_null($enum_definition)) {
            throw new \InvalidArgumentException('non-nullable enum_definition cannot be null');
        }
        $this->container['enum_definition'] = $enum_definition;
    ...
    public function setBuiltInType($built_in_type)
    {
        ...
        if (($built_in_type > 255)) {
            throw new \InvalidArgumentException('invalid value for $built_in_type when calling EnumDescription., must be smaller than or equal to 255.');
        }
        if (($built_in_type < 0)) {
            throw new \InvalidArgumentException('invalid value for $built_in_type when calling EnumDescription., must be bigger than or equal to 0.');
        }
     ...
     * Sets data_type_id
     *
     * @param string|null $data_type_id data_type_id
     *
     * @return self
     */
